...
<body>
<div id="menus" class="jp-box">
  <div class="jp-title-bar">
    <div class="jp-title-bar-text">Menu</div>
...
<div id="menu" class="jp-box jp-hide">
  <div class="jp-title-bar" style="text-align:center;position:fixed;">
    <div id="menu-title" style="padding-top:10px;font-size:18px;"></div>
...
function loadMenuList(paramJson) {
  $ .getJSON("<c:url value='/spring/am/menuPage'/>", paramJson, function(page) {
	...
	$ .each(data, function(index, map) {
	  var uuid = "";
	  var listTds = [];
	  listTds.push("<td><input name='uuid' type='checkbox' class='jp-check-box' value='" + map['menuId'] + "'/></td>");
