...
public class StringUtil {
	...
	public static String toString(BigDecimal bd, int newScale) {
		if (bd==null) {
			return "";
		}
	...
	public static Map<String,String> getMapFromUrlParams(String urlParams) {
		Map<String,String> map = new TreeMap<String,String>();
		String[] strWithEqualArr = urlParams.split("&");
		for (String strWithEqual : strWithEqualArr) {
			String[] strArr = strWithEqual.split("=");
			if (strArr.length==2) {
	...
	public static void main(String[] args) {
		...
		String body = "mid=1000088918&order_number=AC001587&result=Paid&confirmation_code=BFC684&transaction_id=000011025598&authorization_code=T24071" +
				"&card_number=XXXXXXXXXXXX1111¤cy_code=SGD&amount=120.00&authorized_currency_code=SGD&authorized_amount=120.00" + 
				"&signature=8d17b8f3e3dc145c92e17a09d5dff804";
		Map<String,String> map = getMapFromUrlParams(body);
