...
public class UserAgentUtil {  
	...
	public static final String BROWSER_AGENT = "browserAgent";
    ...
    private static void judgeBrowser(String userAgent, Map<String,String> map) {  
        ...
        } else if (userAgent.contains("Mozilla") && userAgent.contains("rv:11")) {  //MSIE 11.0    -   Mozilla/5.0 (Windows NT 6.3; Trident/7.0; rv:11.0) like Gecko
            browserVersion = "11";  
            browserType = "Internet Explorer";
        } else if (userAgent.contains("Safari")) {  
        	//Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.76.4 (KHTML, like Gecko) Version/7.0.4 Safari/537.76.4
        	if (userAgent.contains("Version")) {//Internet Explorer 10  
        		int start = userAgent.indexOf("Version")+8;
        		int end = userAgent.indexOf("Safari")-1;
        		if (start<end && end<=userAgent.length()) {
        ...
        map.put(UserAgentUtil.BROWSER_AGENT, userAgent); 
    }  
}  