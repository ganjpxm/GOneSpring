/**
 * $Id: AmOrgDaoImpl.java, v1.0 2014/12/17 11:31:49 GanJianping Exp $
 *
 ...
 */
@Repository
public class AmOrgDaoImpl extends AbstractHibernateDao<AmOrg> implements AmOrgDao {

    public AmOrgDaoImpl() {
        super();

        setClazz(AmOrg.class);
    }
    ...
    public void batchDelete(final String pks) {
    	String hql = "delete from AmOrg where orgId in (" + StringUtil.getStrWithQuote(pks) + ")";
		batchExecute(hql);
    }
	...
	public Page<AmOrg> getAmOrgPage(final String search, final String startDate, final String endDate, final String dataStates,
		...
		String hql = "select a from AmOrg a where 1=1 ";
