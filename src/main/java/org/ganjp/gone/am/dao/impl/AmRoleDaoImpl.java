/**
 * $Id: AmRoleDaoImpl.java, v1.0 2014/12/17 11:31:49 GanJianping Exp $
 *
 ...
 */
@Repository
public class AmRoleDaoImpl extends AbstractHibernateDao<AmRole> implements AmRoleDao {

    public AmRoleDaoImpl() {
        super();

        setClazz(AmRole.class);
    }
	...
	public Page<AmRole> getAmRolePage(final String search, final String startDate, final String endDate, final String dataStates,
		...
		String hql = "select a from AmRole a where 1=1 ";
