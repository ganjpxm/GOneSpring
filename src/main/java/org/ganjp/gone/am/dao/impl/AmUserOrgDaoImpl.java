/**
 * $Id: AmUserOrgDaoImpl.java, v1.0 2014/12/17 11:31:49 GanJianping Exp $
 *
 ...
 */
@Repository
public class AmUserOrgDaoImpl extends AbstractHibernateDao<AmUserOrg> implements AmUserOrgDao {

    public AmUserOrgDaoImpl() {
        super();

        setClazz(AmUserOrg.class);
    }
    ...
    public void batchDelete(final String pks) {
    	String hql = "delete from AmUserOrg where userOrgId in (" + StringUtil.getStrWithQuote(pks) + ")";
		batchExecute(hql);
    }
	...
	public Page<AmUserOrg> getAmUserOrgPage(final String search, final String startDate, final String endDate, final String dataStates,
		...
		String hql = "select a from AmUserOrg a where 1=1 ";
