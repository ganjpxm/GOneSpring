/**
 * $Id: AmRoleMenuDaoImpl.java, v1.0 2014/12/17 11:31:49 GanJianping Exp $
 *
 ...
 */
@Repository
public class AmRoleMenuDaoImpl extends AbstractHibernateDao<AmRoleMenu> implements AmRoleMenuDao {

    public AmRoleMenuDaoImpl() {
        super();

        setClazz(AmRoleMenu.class);
    }
	...
	public Page<AmRoleMenu> getAmRoleMenuPage(final String search, final String startDate, final String endDate, final String dataStates,
		...
		String hql = "select a from AmRoleMenu a where 1=1 ";
