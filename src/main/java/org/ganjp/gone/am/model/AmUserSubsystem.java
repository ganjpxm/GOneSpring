/**
 * $Id: AmUserSubsystem.java,v 1.0 2012/08/19 00:16:55 GanJianping Exp $
 *
 ...
 */
@Entity
@Table(name="am_user_subsystem")
public class AmUserSubsystem extends BaseModel{
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="user_subsystem_id")
	private String userSubsystemId = UUIDHexGenerator.getUuid();
...
/**
	 * @return String
	 */
	public String getUserSubsystemId() {
        return this.userSubsystemId;
    }
    
    /**
	 * @param String userSubsystemId
	 */
    public void setUserSubsystemId(String userSubsystemId) {
		this.userSubsystemId = userSubsystemId;
    }
    /**
	 * @return String
	 */
