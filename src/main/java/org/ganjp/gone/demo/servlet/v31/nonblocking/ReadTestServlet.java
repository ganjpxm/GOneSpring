...
public class ReadTestServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter output = response.getWriter()) {
            ...
            // TODO: This is redundant code and should only be specified once in MyReadListener. For now, all the data from InputStream need to be read before ReadListener is engaged.
            // EG has already agreed on simplification and the implementation will be updated to reflect that. This sample will be updated after that.
            int b = -1;
