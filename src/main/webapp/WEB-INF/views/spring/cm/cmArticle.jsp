...
<body>
<div id="articles" class="jp-box">
  <div class="jp-title-bar">
    <div class="jp-title-bar-text">Article</div>
...
<div id="article" class="jp-box jp-hide">
  <div class="jp-title-bar" style="text-align:center;position:fixed;">
    <div id="article-title" style="padding-top:10px;font-size:18px;"></div>
...
function search() {
  ...
  loadArticleList(mParamJson);
}

function loadArticleList(paramJson) {
  $ .getJSON("<c:url value='/spring/cm/articlePage'/>", paramJson, function(page) {
	...
	$ .each(data, function(index, map) {
	  var uuid = "";
	  var listTds = [];
	  listTds.push("<td><input name='uuid' type='checkbox' class='jp-check-box' value='" + map['articleId'] + "'/></td>");
