...
<body>
<div id="websites" class="jp-box">
  <div class="jp-title-bar">
    <div class="jp-title-bar-text">Website</div>
...
<div id="website" class="jp-box jp-hide">
  <div class="jp-title-bar" style="text-align:center;position:fixed;">
    <div id="website-title" style="padding-top:10px;font-size:18px;"></div>
...
function search() {
  ...
  loadWebsiteList(mParamJson);
}

function loadWebsiteList(paramJson) {
  $ .getJSON("<c:url value='/spring/cm/websitePage'/>", paramJson, function(page) {
	...
	$ .each(data, function(index, map) {
	  var uuid = "";
	  var listTds = [];
	  listTds.push("<td><input name='uuid' type='checkbox' class='jp-check-box' value='" + map['websiteId'] + "'/></td>");
