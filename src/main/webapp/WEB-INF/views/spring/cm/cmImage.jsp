...
<body>
<div id="images" class="jp-box">
  <div class="jp-title-bar">
    <div class="jp-title-bar-text">Image</div>
...
<div id="image" class="jp-box jp-hide">
  <div class="jp-title-bar" style="text-align:center;position:fixed;">
    <div id="image-title" style="padding-top:10px;font-size:18px;"></div>
...
function search() {
  ...
  loadImageList(mParamJson);
}

function loadImageList(paramJson) {
  $ .getJSON("<c:url value='/spring/cm/imagePage'/>", paramJson, function(page) {
	...
	$ .each(data, function(index, map) {
	  var uuid = "";
	  var listTds = [];
	  listTds.push("<td><input name='uuid' type='checkbox' class='jp-check-box' value='" + map['imageId'] + "'/></td>");
