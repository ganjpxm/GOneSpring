...
<body>
<div id="roles" class="jp-box">
  <div class="jp-title-bar">
    <div class="jp-title-bar-text">Role</div>
...
<div id="role" class="jp-box jp-hide">
  <div class="jp-title-bar" style="text-align:center;position:fixed;">
    <div id="role-title" style="padding-top:10px;font-size:18px;"></div>
...
function loadRoleList(paramJson) {
  $ .getJSON("<c:url value='/spring/am/rolePage'/>", paramJson, function(page) {
	...
	$ .each(data, function(index, map) {
	  var uuid = "";
	  var listTds = [];
	  listTds.push("<td><input name='uuid' type='checkbox' class='jp-check-box' value='" + map['roleId'] + "'/></td>");
