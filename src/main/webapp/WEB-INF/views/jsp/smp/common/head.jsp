  ...
  <link rel="stylesheet" href="<c:url value='/resources/other/normalize.css'/>"/>
  <link rel="stylesheet" href="<c:url value='/resources/bootstrap/v3.3.2/css/bootstrap.min.css'/>"/>
  <link rel="stylesheet" href="<c:url value='/resources/bootstrap-datepicker/css/bootstrap-datepicker.css'/>"/>
  ...
  <link rel="stylesheet" href="<c:url value='/resources/intl-tel-input/css/intlTelInput.css'/>"/>
  <link rel="stylesheet" href="<c:url value='/resources/chosen/v1.1/chosen.css'/>"/>
  <link rel="stylesheet" href="<c:url value='/resources/jp/jp.css'/>"/>
  <link rel="stylesheet" href="<c:url value='/resources/jp/jp-login.css'/>"/>
  <link rel="stylesheet" href="<c:url value='/resources/jp/jp-teal.css'/>"/>