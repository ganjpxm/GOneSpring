...
<body>
<div id="params" class="jp-box">
  <div class="jp-title-bar">
    <div class="jp-title-bar-text">Param</div>
...
<div id="param" class="jp-box jp-hide">
  <div class="jp-title-bar" style="text-align:center;position:fixed;">
    <div id="param-title" style="padding-top:10px;font-size:18px;"></div>
...
function loadParamList(paramJson) {
  $ .getJSON("<c:url value='/bm/paramPage'/>", paramJson, function(page) {
	...
	$ .each(data, function(index, map) {
	  var uuid = "";
	  var listTds = [];
	  listTds.push("<td><input name='uuid' type='checkbox' class='jp-check-box' value='" + map['paramId'] + "'/></td>");
